...
export function Home() {
  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      {showCursor && (
        <div
          className="fixed pointer-events-none z-50 text-white text-xl tracking-wider"
          style={{
      ...
      {/* Scroll Cursor for right column (not on images) */}
      {showScrollCursor && !showCursor && (
        <div
          className="fixed pointer-events-none z-50 text-gray-400 text-xl tracking-wider"
          style={{
            left: `${cursorPosition.x}px`,
            top: `${cursorPosition.y}px`,
            transform: 'translate(-50%, -50%)',
      ...
      <div className="flex flex-col lg:flex-row min-h-screen">
        {/* Left Column */}
        <div className="w-full lg:w-1/2 flex items-start px-6 pt-20">
          <h1 className="font-bold leading-none tracking-tight text-[clamp(4rem,15vw,9rem)]">
            Hi, I'm<br />Yujing Shi,
          </h1>
        </div>

        {/* Right Column - Scrollable on its own */}
        <div
          ref={rightColumnRef}
        ...
        >
          ...
          <div ref={projectsRef} data-section="projects" className="min-h-screen py-8 px-3">
            <h2 className="tracking-tight mb-8 text-[36px] italic font-bold">PROJECTS</h2>
          ...
          <div ref={contactRef} data-section="contact" className="min-h-screen py-8 px-3">
            <div className="flex gap-8">
              ...
              <div className="flex-1">
                <h2 className="text-[36px] tracking-tight mb-8 font-bold">CONTACT</h2>
                <div className="space-y-4">
                  <div>
                    <p className="text-xl text-gray-500 mb-2">Instagram</p>
                    <a
                      href="https://instagram.com/yujing.context"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="block text-xl hover:opacity-60 transition-opacity"
                    >
                      @yujing.context
                    </a>
                  </div>
                  <div>
                    <p className="text-xl text-gray-500 mb-2">Behance</p>
                    <a
                  ...
                  <div>
                    <p className="text-xl text-gray-500 mb-2">LinkedIn</p>
                    <a
